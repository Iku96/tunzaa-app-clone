...
export const authApi = {
    ...
    register: async (data: RegisterBody): Promise<AuthResponse> => {
        return (await apiClient.post<AuthResponse>("/auth/register", data)).data;
    },
    ...
    updateUserProfile: async (userId: string, profileId: string, data: any): Promise<any> => {
        const id = userId || 'me';
        return (await apiClient.put(`/users/${id}/profile/${profileId}`, data)).data;
    },
    updatePassword: async (userId: string, data: any): Promise<any> => {
        const id = userId || 'me';
        return (await apiClient.put(`/users/${id}/password`, data)).data;
    },
