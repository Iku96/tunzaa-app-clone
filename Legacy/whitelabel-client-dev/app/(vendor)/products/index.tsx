...
import { View, ScrollView, Image, Alert, KeyboardAvoidingView, Platform, TouchableOpacity, RefreshControl } from "react-native";
...
export const ProductsScreen = () => {
  ...
  const handleProductSubmit = async (productData: any, product?: ProductResponse) => {
    ...
    try {
      if (product) {
        ...
        // Use all productData fields to ensure variants and other new fields are included
        const createData = {
          ...productData,
          vendor_id: VENDOR_ID,
          store_id: STORE_ID,
        ...
        console.log("Final createData being sent:", createData);
  ...
  // Calculate total inventory for footer
        ...
        {isDesktop ? (
            ...
            {!vendorDetails ? (
              <View className="flex-1 justify-center items-center py-10">
                <Text className="text-muted-foreground text-lg">
                  {isProfileLoading
                    ? "Loading profile..."
                    : "No vendor details available. Please ensure you have a vendor profile."}
                </Text>
              </View>
            ) : isProductsLoading ? (
              <View className="flex-1 justify-center items-center py-10">
          ...
          <SafeAreaView className="flex-1 bg-background" edges={["top", "right", "left"]}>
            <View className="p-4 border-b border-border">
              <Text className="text-2xl font-bold text-foreground mb-1">Products</Text>
              {vendorDetails && (
