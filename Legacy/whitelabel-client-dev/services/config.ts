export const API_CONFIG = {
  BASE_URL:
    ...
    // "https://tm-api-uat.cheetah.co.tz/v1", //
  DOCUMENT_UPLOAD_URL:
    process.env.EXPO_PUBLIC_DOCUMENT_UPLOAD_URL || "https://docs.afrizon.africa/api/documents",
    // "https://documents-dev.usereli.tech/api/documents",
  TENANT_ID:
    process.env.EXPO_PUBLIC_TENANT_ID || "429841b1-76a3-4d67-a5fc-1c61178bb6a7", //"f1091059-4bbd-4d64-84e9-e4dc008b282d", //
  APP_URL:
    process.env.EXPO_PUBLIC_APP_URL || "https://afrizon.africa",
    // "https://afrizon-uat.cheetah.co.tz", 
  TIMEOUT: 30000,
  HEADERS: {
