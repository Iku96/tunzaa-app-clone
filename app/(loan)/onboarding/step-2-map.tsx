...
export default function LoanStep2Map() {
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                if (status === 'granted') {
                    console.log('📍 [LoanStep2Map] Location permission granted, fetching position...');
                    ...
                    console.warn('⚠️ [LoanStep2Map] Location permission denied');
                }
            } catch (error) {
                console.error('❌ [LoanStep2Map] Error fetching location:', error);
            }
        })();
    }, []);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            console.error('❌ [LoanStep2Map] Save failed:', e);
        } finally {
            setLoading(false);
        }
    };
                ...
                >
                    <View style={styles.staticContent}>
                        ...
                        <Text style={styles.subtitle}>
                            Buruta pini kwenye ramani kuonyesha ofisi ilipo.
                        </Text>
                        ...
                        <View style={styles.mapContainer}>
                            ...
                            >
                                ...
                                >
                                    <Callout>
                                        <Text>Ofisi Ya Kampuni Yako</Text>
                                    </Callout>
                                </Marker>
                            </MapView>
                        </View>
