            ...
            <ScrollView contentContainerStyle={styles.content}>
                {isLoading ? (
                    <View style={{ padding: 40, alignItems: 'center' }}>
                        ...
                        <Text style={{ marginTop: 10, color: '#6B7280' }}>Loading plan details...</Text>
                    </View>
                ) : !product ? (
                    <View style={{ padding: 40, alignItems: 'center' }}>
                        <Text style={{ color: '#EF4444' }}>Product not found.</Text>
                    </View>
                ) : (
                    <>
                        ...
                        <Text style={styles.priceLabel}>
                            Total Price: <Text style={styles.priceValue}>Tzs {product.price.toLocaleString()}</Text>
                        </Text>
            ...
            >
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <Text style={styles.modalTitle}>Great Progress!</Text>
