...
export default function MerchantSharesScreen() {
    ...
    const engagementData = useMemo(() => {
        ...
        return baseItems.map((item: any, index) => {
            ...
            const shares = (orderCount * 5) + (index % 3) + 4;
    ...
    const totalShares = useMemo(() => engagementData.reduce((sum, item) => sum + item.shares, 0), [engagementData]);
    ...
    const renderProductItem = ({ item, index }: { item: any, index: number }) => (
        ...
        >
            ...
            <View style={styles.productRight}>
                ...
                <Text style={styles.countLabel}>Shares</Text>
            </View>
        </TouchableOpacity>
    );
    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Shares Analytics</Text>
                <View style={{ width: 24 }} />
            </View>

            <View style={styles.summaryCard}>
                <Text style={styles.summaryLabel}>Total shares of your products</Text>
                <Text style={styles.summaryValue}>{totalShares.toLocaleString()}</Text>
                <View style={[styles.trendRow, { backgroundColor: '#EEF2FF' }]}>
                    <Ionicons name="share-social" size={16} color="#425BA4" />
                    <Text style={[styles.trendText, { color: '#425BA4' }]}>Increasing reach</Text>
                </View>
            </View>

            <View style={styles.listHeaderRow}>
                <View>
                    <Text style={styles.listTitle}>Most Shared Products</Text>
                    <TouchableOpacity 
            ...
            {engagementData.length === 0 ? (
                <View style={styles.emptyContainer}>
                    ...
                    <Text style={styles.emptyText}>No share data available for {dateFilter.toLowerCase()}.</Text>
                </View>
            ) : (
                <FlatList
                    data={engagementData}
