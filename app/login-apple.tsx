...
/**
 * Login with Apple Screen
 * Social auth screen with Apple branding
 */
export default function LoginAppleScreen() {
    ...
    const handleLogin = () => {
        ...
        console.log('Apple Login:', { email, password });
        router.push('/home');
    };
            ...
            <View style={styles.container}>
                <View style={styles.contentWrapper}>
                    ...
                    <View style={styles.header}>
                        ...
                        <Text style={styles.title}>Login with Apple</Text>
                    </View>

                    {/* Apple Icon */}
                    <View style={styles.iconContainer}>
                        <View style={styles.iconCircle}>
                            <Ionicons name="logo-apple" size={48} color="#FFFFFF" />
                        </View>
                    </View>
