            ...
            <View style={styles.contentWrapper}>
                ...
                <View>
                    ...
                    <Text style={styles.subtitle}>
                        Hakiki taarifa za kampuni yako kabla ya kuendelea.
                    </Text>
                    ...
                    <View style={styles.card}>
                        ...
                        <View style={styles.cardHeader}>
                            <View style={styles.headerTitleRow}>
                                ...
                                <Image
                                    ...
                                    resizeMode="contain"
                                />
                                <Text style={styles.cardTitle}>Eneo la Kampuni</Text>
                            </View>
                        ...
                        <View style={styles.cardFooterLink}>
                            <Text style={styles.textLinkQuestion}>Una ofisi zaidi ya eneo moja? </Text>
                            <TouchableOpacity onPress={() => alert('Add Office clicked')}>
                                <Text style={styles.textLinkAction}>Ongeza Ofisi</Text>
                            </TouchableOpacity>
                        </View>
                ...
                <View style={styles.footer}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => router.push('/(delivery)/delivery-documents')}
                    >
